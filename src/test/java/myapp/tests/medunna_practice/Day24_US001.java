...
*/
    ...
    public void medunnaTest2() {
        ...
        BrowserUtils.verifyElementDisplayed(medunnaRegistrationPage.requiredSsnMessage);
        ...
        BrowserUtils.verifyElementNotDisplayed(medunnaRegistrationPage.requiredSsnMessage);


    }

    //There should be a valid name that contains any chars and cannot be blank
    @Test
    ...
    //There should be a valid lastname that contains any chars and it is a required field
    @Test
    public void medunnaTest4() {
        // User leaves the lastname blank, there should be "Your LastName is required." message
        ...
        // User enters the lastname only space, there should be "Your LastName is required." message
        medunnaRegistrationPage.lastName.clear();
        medunnaRegistrationPage.lastName.sendKeys(Keys.SPACE);
        BrowserUtils.verifyElementDisplayed(medunnaRegistrationPage.lastNameRequiredMessage);

        // User enters the lastname that contains any chars, there should not be any error message
        medunnaRegistrationPage.lastName.clear();
        medunnaRegistrationPage.lastName.sendKeys("Arslan", Keys.ENTER);
